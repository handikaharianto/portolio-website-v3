      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative flex items-center space-x-1 font-medium text-zinc-600 transition duration-300 hover:text-blue-600 focus:outline-2 focus:outline-offset-2 focus:outline-blue-600",
            )}
          >
